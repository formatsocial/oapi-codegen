...
import (
	...
	examplePetstoreClient "github.com/formatsocial/oapi-codegen/examples/petstore-expanded"
	examplePetstore "github.com/formatsocial/oapi-codegen/examples/petstore-expanded/echo/api"
...
const (
	...
	remoteRefImport = `github.com/formatsocial/oapi-codegen/examples/petstore-expanded`
)
...
type GetTestByNameResponse struct {
	...
	assert.Contains(t, code, "DogAge            string  `dynamodbav:\"dogAge\" json:\"dogAge\"`")
...
func TestRemoteExternalReference(t *testing.T) {
	...
	// Check import
	assert.Contains(t, code, `externalRef0 "github.com/formatsocial/oapi-codegen/examples/petstore-expanded"`)
